...
class _FitnessPageState extends State<FitnessPage> {
  ...
  final List<String> _fitnessGoals = ["Weight Loss", "Muscle Gain", "Tone Body", "Improves Stamina", "General Fitness"];
  final List<String> _fitnessLevel = ["Beginner", "Intermediate", "Pro"];
          ...
          TextButton.icon(
            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                ...
                try {
                  await UserModel.User().saveUser(true);
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              children: <Widget>[
                Text("Fitness Information", style: theme.textTheme.displayMedium!.copyWith(
                      ...
                      children: [
                        DropdownButtonFormField<String>(
                          ...
                          onChanged: (String? newValue) {
                            setState(() {
                              UserModel.User().fitnessGoal = newValue!;
                            });
                          },
                          validator: (value) {
                            if (value == null) {
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          items: _fitnessLevel.map((String item) {
                            return DropdownMenuItem<String>(
                              value: item,
                              child: Text(item),
                            );
                          ...
                          onChanged: (String? newValue) {
                            setState(() {
                              UserModel.User().fitnessLevel = newValue!;
                            });
                          },
                          validator: (value) {
                            if (value == null) {
