...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // Check if the image is null before proceeding
  if (img == null) {
    isBusy = false; // Reset the flag so the next frame can be processed
    return; // Exit the function immediately
  }

  InputImage? inputImage = await _inputImageFromCameraImage();

  // Also, check if the input image could be created successfully
  if (inputImage == null) {
    isBusy = false;
    return;
  }
